		...
		<div class="fb">
			<ul>
				...
				<li @click="showBuyhurry()">
					<p><span class="star">*</span>秒杀详细内容</p><p v-html="pintuan"></p><i class="iconfont">&#xe61f;</i>
				</li>
...
//					that.$message.warning('秒杀价格不能为空！');
//				}else if(!that.subdata.num){
//					that.$message.warning('秒杀人数不能为空！');
//				}else if(!that.subdata.hd_start_time || !that.subdata.hd_end_time){
//					that.$message.warning('秒杀开始结束时间不能为空！');
