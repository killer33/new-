	...
	export default{
		...
		mounted(){
			...
			this.$nextTick(()=>{
				...
				$.ajax({
					type:"post",
					url:join+"index/love_more_activity",//搜索接口
					dataType:"json",
					data:{page:page },
		    	...
		    	window.addEventListener('scroll',function(){   
		    		...
		    		if (viewHeight+scrollTop==scrollHeight) {
		    			if (sw==true) {
		    				...
		    				sw=false;
		    				$.ajax({
		    					url:join+"index/love_more_activity",
		    					type:"post",
		    					data:{
									page:page
								},
...
<style>
	*{
	...
	.home-moreActivities .head3{
		width: 100%;
		height: 3.5rem;
		border-bottom: 1px solid #F0F0F0;
	}
	.home-moreActivities .head3>p{
		width: 10%;
	    height: 3.5rem;
	    line-height: 3.5rem;
	    text-align: center;
	...
	.home-moreActivities .head3>p:nth-child(2){
		margin-left: 35%;
		font-size: 15px;
	}
	.home-moreActivities .love1{
		width: 100%;
		margin-top: 2%;
		padding-bottom: 2.5rem;
	}
	.home-moreActivities .love1>ul{
		width: 100%;
		background: ;
	}
	.home-moreActivities .love1>ul>li{
		width: 45%;
	    height: 13rem;	
	    float: left;
	    margin-left: 3%;  
	...
	.home-moreActivities .love1>ul>li:nth-child(n+3){
		 margin-top: 3%;
	}
	.home-moreActivities .love1>ul>li>img{
		width: 100%;
	    height: 8rem;
	    margin-left: 0%;
	    border-radius: 5px;
	}
	.home-moreActivities .love1>ul>li>p{
		margin-left: 2%;
		margin-top: 2%;
		text-align: left;
	}
	.home-moreActivities .Ph11{
		font-size: 1.5rem;
		margin-left: 4% !important;
		height: 2rem;
	}
	.home-moreActivities .Ph11>span{
		font-weight: bold;
	...
	.home-moreActivities .Ph22{
		color: #A1A1A1;
	}
	.home-moreActivities .col{
		color: #FAE64F;
	}
	.home-moreActivities .col_s{
		margin-left: 57%!important;
	}
	.home-moreActivities .Ph22>span:last-child{
		margin-left: 10%;
	}
</style>